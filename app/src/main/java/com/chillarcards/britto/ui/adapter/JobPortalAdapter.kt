...
class JobPortalAdapter(
    ...
    : RecyclerView.Adapter<JobPortalAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.adapter_job_bc, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val jobApplied: TextView = itemView.findViewById(R.id.tvapplied)
        ...
        fun bind(item: DummyJob) {
            ...
            if (item.categ == "0") {
                jobApplied.text = "Applied: 5"
            }
            if (item.categ == "1") {
                jobApplied.text = "Applied: 0"
            }
            if (item.categ == "2") {
                jobId.text = "No Application"
            }
