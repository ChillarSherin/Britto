...
open class LabFragment : Fragment(), IAdapterViewUtills {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.departRv.adapter = SpecialtyAdapter(medicalSpecialties,this@LabFragment)
        ...
        val docTopPicAdapter = HospitalDoctorAdapter(
            dummyDoc, context,activity,this@LabFragment)
