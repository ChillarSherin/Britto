...
class LandMapFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_landmap, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Handler().postDelayed({
            binding.firstLod.visibility = View.GONE
        }, 2000)
      ...
      //            searchPlace()
        ...
        binding.loginBtn.setOnClickListener{
            findNavController().navigate(
                LandMapFragmentDirections.actionMapFragmentToLandFragment(
                )
            )
        }
    }
