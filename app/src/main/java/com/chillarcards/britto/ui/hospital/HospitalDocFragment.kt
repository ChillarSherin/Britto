...
open class HospitalDocFragment : Fragment(), IAdapterViewUtills {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val docTopPicAdapter = HospitalDoctorAdapter(
            dummyDoc, context,activity,this@HospitalDocFragment)
    ...
    override fun getAdapterPosition(
        ...
        if(Mode.equals("DOC")) {
            ...
            findNavController().navigate(
                HospitalDocFragmentDirections.actionHospitalFragmentToDetailsFragment(doctorId,doctorName)
            )
        }
    }
