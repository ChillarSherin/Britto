package com.chillarcards.britto.ui.order
...
import com.chillarcards.britto.ui.adapter.OrderHistoryAdapter
import com.chillarcards.britto.ui.interfaces.IAdapterViewUtills
import com.chillarcards.britto.ui.partners.OrderDetailFragmentDirections
import com.chillarcards.britto.utills.CommonDBaseModel
import com.chillarcards.britto.utills.PrefManager

open class OrderHistoryFragment : Fragment(), IAdapterViewUtills {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val orderPicAdapter = OrderHistoryAdapter(
            dummyOrd, context,activity,"order",this@OrderHistoryFragment)
...
//                OrderDetailFragmentDirections.ac(pharmacyId,pharmacyName
//                )
//            )
        }
    }
