...
import com.chillarcards.britto.ui.adapter.JobPortalAdapter
import com.chillarcards.britto.ui.interfaces.IAdapterViewUtills
import com.chillarcards.britto.utills.CommonDBaseModel
import com.chillarcards.britto.utills.PrefManager

open class JobAppliedFragment : Fragment(), IAdapterViewUtills {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val commonAdapter = JobPortalAdapter(
            dummyPhar, context,activity,this@JobAppliedFragment)
    ...
    override fun getAdapterPosition(
        ...
        if(Mode.equals("VIEW")) {
            ...
            findNavController().navigate(
                JobAppliedFragmentDirections.actionJobRequestFragmentToDetailviewFragment(pharmacyId
                )
            )
        }
    }
