...
import com.chillarcards.britto.ui.adapter.JobHistoryAdapter
import com.chillarcards.britto.ui.interfaces.IAdapterViewUtills
import com.chillarcards.britto.utills.CommonDBaseModel
import com.chillarcards.britto.utills.PrefManager

open class ViewIntrestFragment : Fragment(), IAdapterViewUtills {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val orderPicAdapter = JobHistoryAdapter(
            dummyOrd, context,activity,"order",this@ViewIntrestFragment)
